...
import 'widgets/car_features_widget.dart';
import 'widgets/car_gallery_widget.dart';
import 'widgets/car_location_widget.dart';
import 'widgets/car_specs_widget.dart';
import 'widgets/details_screen_app_bar.dart';
import 'widgets/description_widget.dart';
import 'widgets/detailed_info_widget.dart';
import 'widgets/modifications_widget.dart';
...
class _CarDetailsScreenState extends State<CarDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider.value(
      value: getIt.get<CarListingCubit>(),
      child: BlocListener<CarListingCubit, CarListingState>(
            ...
            children: [
              SingleChildScrollView(
                ...
                child: Column(
                  spacing: AppSize.s30,
                  children: [
                    CarGalleryWidget(car: widget.car),
