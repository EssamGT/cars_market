...
import '../car_edit_steps/step_1/step_1.dart';
import '../car_edit_steps/step_2/step_2.dart';
import '../car_edit_steps/step_3/step_3.dart';
...
class CarEditStepsController extends GetxController {
  ...
  void changeIndex(int index) async {
    ...
    if (index >= steps.length) {
      getIt.get<CarEditCubit>().uploadCar();
