...
import 'package:update_user_data/presentation/widgets/otp_screen/widgets/otp_text_widget.dart';

class OtpVerifyScreenForPhoneUpdate extends StatefulWidget {
  const OtpVerifyScreenForPhoneUpdate({super.key});

  @override
  State<OtpVerifyScreenForPhoneUpdate> createState() => _OtpVerifyScreenForPhoneUpdateState();
}

class _OtpVerifyScreenForPhoneUpdateState extends State<OtpVerifyScreenForPhoneUpdate> {
        ...
        body: Padding(
          ...
          child: BlocConsumer<UpdateUserDataCubit, UpdateUserDataState>(
            ...
            builder: (context, state) {
              var cubit = getIt<UpdateUserDataCubit>();
              ...
              return Form(
                ...
                child: Column(
                  ...
                  children: [
                    OtpTextWidget(phoneNumber: cubit.newPhoneNumber),
