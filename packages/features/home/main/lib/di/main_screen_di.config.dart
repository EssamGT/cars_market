...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i632.MainScreenDataSource>(
      () => _i565.DataSourceImpl(storageManager: gh<_i760.FirebaseDbManager>()),
    );
    gh.lazySingleton<_i566.MainScreenRepository>(
    ...
    gh.lazySingleton<_i621.MainScreenCubit>(
